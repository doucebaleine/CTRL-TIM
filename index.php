...
<main>
   ...
   <section class="accueil__exposition">
      <div class="accueil__exposition__textePrincipal">
         <div class="accueil__exposition__textePrincipal__titre">
         ...
         <div class="accueil__exposition__textePrincipal__description">
      ...
      <div class="accueil__exposition__galerie" aria-hidden="false">
         <div class="accueil__exposition__galerie__affiches" aria-live="polite">
            <?php
