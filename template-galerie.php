...
<main class="pageGalerie">
    ...
    <section class="pageGalerie__galerieProjets">
      <div class="pageGalerie__galerieProjets__projets">
        ...
        <div class="pageGalerie__galerieProjets__projets__projet" data-category="arcade">
          ...
          <div class="pageGalerie__galerieProjets__projets__projet__info">
            <span class="pageGalerie__galerieProjets__projets__projet__info__category">Arcade</span>
        ...
        <div class="pageGalerie__galerieProjets__projets__projet" data-category="terre">
          <img src="<?php echo get_template_directory_uri(); ?>/images/DeathStranding.jpg" alt="Death Stranding">
          <div class="pageGalerie__galerieProjets__projets__projet__info">
            <span class="pageGalerie__galerieProjets__projets__projet__info__category">Terre</span>
            <h3 class="pageGalerie__galerieProjets__projets__projet__info__titre">Death Stranding</h3>
          </div> 
        </div>

        <div class="pageGalerie__galerieProjets__projets__projet" data-category="finissants">
          <img src="<?php echo get_template_directory_uri(); ?>/images/EldenRing.jpg" alt="Elden Ring">    
          <div class="pageGalerie__galerieProjets__projets__projet__info">
            <span class="pageGalerie__galerieProjets__projets__projet__info__category">Finissants</span>
